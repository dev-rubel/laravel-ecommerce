...
class CategoriesController extends Controller
{
    public function index()
    {
        ...
        return view('admin_panel.categories.index')->with('catlist', $result);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin_panel.categories.edit')->with('category', $cat);
    }
    ...
    {
        $cat = Category::find($id);
        return view('admin_panel.categories.delete')->with('category', $cat);
    }
