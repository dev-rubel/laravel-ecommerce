        ...
        <div class="col-md-12 d-flex align-items-stretch grid-margin">
            <div class="row flex-grow">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a style="color: green;" href="{{route('admin.products')}}"> < Back to List</a>
                            <br />
                            <br />
                            <h4>Create product</h4>
                            <br />
                            <img id="imageHolder" src="https://ctt.trains.com/sitefiles/images/no-preview-available.png" alt="add image" height="300" width="300" />
                            <br /><br />
                            ...
                            <form class="forms-sample" method="post" id="product_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-md" id="Category" name="Category">
                                        @php foreach($catlist->all() as $cat) { echo "
                                        <option value=".$cat->id.">".$cat->name." </option>
                                        "; $select_attribute=''; } @endphp
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <br />
                                    <br />
                                    <div id="colors" style="border: 1px solid #eee;"></div>
                                    <br />
